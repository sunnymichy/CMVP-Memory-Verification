...
!!! This is real Windows process-memory code. Run as Administrator (SeDebugPrivilege).
    It cannot be tested in the assistant's environment; validate output before use. !!!
...
def main():
    ...
    out = {"module": a.module, "library": a.library, "predicted_key_blocks": preds, "funnel": funnel}
