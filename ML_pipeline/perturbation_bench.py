...
NO number is hard-coded into the paper; paste the two runs' output back to fill the
placeholders. Windows only (ctypes psapi/ntdll). Requires the `cryptography` package.
"""
